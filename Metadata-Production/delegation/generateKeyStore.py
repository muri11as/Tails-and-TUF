...
CS9163
Modified: Toan Nguyen, Kevin Ngao
...
##Add Delegations
generate_and_write_rsa_keypair(path+"stable",bits=3072,password=stablepwd)
generate_and_write_rsa_keypair(path+"beta",bits=3072,password=betapwd)
generate_and_write_rsa_keypair(path+"nightly",bits=3072,password=nightly)
